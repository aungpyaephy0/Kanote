    ...
    <main>
        ...
        <section class="Features-Artworks-container">
            ...
            <div class="container text-start-end" style="color: var(--primary);">
                ...
                <h3 style="color:black">Galleries &reg;</h3>
                        ...
                        <div class="row g-4">
                            <div class="col ">
                                <div class="card" style="width: 25rem;">
                                    <img src="images/populargallery.png" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5>Myanm/art</h5>
                                        <img src="icons/location.png" width="20px" height="20px" alt="">Yangon, Myanmar
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                ...
                <section class="popular">
                    <div class="container" style="color: var(--primary)">
                        ...
                        <!-- Get-the-app-grid -->
                        <div class="get-the-app grid" style="--bs-gap: 0; width: 1239px; height: 408px;">
